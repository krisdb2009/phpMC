<?php
	...
	*/
	...
	define("PREVIEW_MAX_WIDTH", 950);
	define("PREVIEW_MAX_HEIGHT", 660);
	...
	$color_img_box_back = "linear-gradient(to bottom,  #515151 0%,#1e1e1e 100%)";
	$color_img_box_text = "lightgray";
	$color_img_hover = "white";
	$color_img_hover_text = "black";
	...
	$color_button_hover = "gray";
	$color_button_hover_text = "white";
